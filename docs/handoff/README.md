...
| Archivo | Descripcion |
|---------|-------------|
| `ups-expresosapp-openapi.json` | Especificacion OpenAPI 3.0 completa con los 40 endpoints. Importar en Apidog, Swagger UI o Postman. |
...
| `API_CONTRACT_SUMMARY.md` | Tabla resumen de los 40 endpoints con metodo, ruta, modulo, proteccion, rol y consumidor. |
...
5. Los 40 endpoints apareceran organizados por tags:
   - **Health** (2 endpoints)
   - **Auth** (5 endpoints)

...
describe('TripFeedbackService', () => {
  ...
  describe('findAll', () => {
    ...
    it('should filter by userId when provided', async () => {
      ...
      // Act
      await service.findAll(1, 10, 'user-filter');
    ...
    it('should filter by routeId when provided', async () => {
      ...
      // Act
      await service.findAll(1, 10, undefined, 'route-filter');
    ...
    it('should filter by both userId and routeId when both provided', async () => {
      // Arrange
      mockFeedbackFindMany.mockResolvedValue([]);
      mockFeedbackCount.mockResolvedValue(0);

      // Act
      await service.findAll(1, 10, 'user-1', 'route-1');
    ...
    it('should use empty where when no filters provided', async () => {
      // Arrange
      mockFeedbackFindMany.mockResolvedValue([]);
      mockFeedbackCount.mockResolvedValue(0);
  ...
  describe('findOne', () => {
    it('should return feedback by ID', async () => {
      ...
      // Act
      const result = await service.findOne('feedback-target');
